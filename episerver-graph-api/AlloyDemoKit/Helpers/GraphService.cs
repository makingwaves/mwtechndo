    ...
    public class GraphService
    {
        ...
        public async Task<CompositeGraphObject> GetUserJson(string email, string search = null)
        {
            ...
            try
            {
                ...
                List<DriveItem> driveSharedItems = null; // await GetListOfObjectsFromGraph<DriveItem>(httpClient, "me/drive/sharedWithMe");
                ...
                return new CompositeGraphObject()
                {
                    User = me,
                    DriveItems = sharedDocumentItems
                };
