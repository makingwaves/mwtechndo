...
const RecentFile: FunctionComponent<RecentFileProps> = ({ name, type, lastUpdate, updatedBy, webUrl }) => {
  return (
    <a href={webUrl} className={classNames(Styles.container, 'mt-lg flex no-underline')}>
