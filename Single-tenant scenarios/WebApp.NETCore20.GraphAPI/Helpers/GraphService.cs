...
namespace WebApp.NETCore20.GraphAPI.Helpers
{
    public class GraphService
    {
        ...
        public GraphService(IMemoryCache memoryCache, IGraphSdkHelper graphSdkHelper, IGraphAuthProvider authProvider)
        {
        ...
        public async Task<CompositeGraphObject> GetUserJson(string userId, string search = null)
        {
            ...
            try
            {
                ...
                this.memoryCache.Set("compositeGraphObject", compositeGraphObject);
